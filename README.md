...
-User Login Credentials: Create a user account from the registration page.
- 
<hr>
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/Radhadgit/online-bookstore.git```> Select master Branch > Next > Next > Finish.
...
Step 8: Step 8: Register a new user account to access the bookstore.
